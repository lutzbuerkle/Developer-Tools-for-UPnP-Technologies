========================================================================
       Windows CE APPLICATION : PPC Media Server
========================================================================


AppWizard has created this PPC Media Server application for you.  

This file contains a summary of what you will find in each of the files that
make up your PPC Media Server application.
...
PPC Media Server.ico
    This is an icon file, which is used as the application's icon (32x32).
    This icon is included by the main resource file PPC Media Server.rc.
...
StdAfx.h, StdAfx.cpp
    ...
    named PPC Media Server.pch and a precompiled types file named StdAfx.obj.
